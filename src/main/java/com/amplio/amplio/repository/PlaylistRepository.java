...
public interface PlaylistRepository extends CrudRepository<Playlist, Integer> {
  ...
  @Query(value = "Select * from playlist where owner_id = :id and is_public = true ", nativeQuery = true)
  Set<Playlist> findPlaylistsByOwnerAndPublic(@Param("id") Integer ownerId);

  @Query(value = "Select * from playlist where title like %:query% and is_public = true ", nativeQuery = true)
